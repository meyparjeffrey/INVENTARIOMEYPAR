...
import { DateRangeSlider, getDateFromSliderValue, getSliderValueFromDate } from "../ui/DateRangeSlider";
...
export function ProductFilters({ filters, onFiltersChange, onClear }: ProductFiltersProps) {
  ...
  const handleSliderChange = (type: "modified" | "created", value: number | undefined) => {
    if (value === undefined) {
      if (type === "modified") {
              ...
              <div className="space-y-4">
                  ...
                  <div className="mt-1 grid grid-cols-2 gap-2">
                    <div>
                      <Input
                        ...
                        onChange={(e) =>
                          handleFilterChange("stockMinMin", e.target.value ? Number(e.target.value) : undefined)
                        }
                      />
                    </div>
                    <div>
                      <Input
                        ...
                        onChange={(e) =>
                          handleFilterChange("stockMinMax", e.target.value ? Number(e.target.value) : undefined)
                        }
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-1 flex flex-wrap gap-2">
                    {(["OK", "DEFECTIVE", "BLOCKED", "EXPIRED"] as const).map((status) => (
                      <label key={status} className="flex items-center gap-2">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            handleFilterChange("batchStatus", updated.length > 0 ? updated : undefined);
                          }}
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">
                      {t("filters.stockNearMinimum") || "Productes al 15% del stock mínim"}
                    </span>
                  </label>
                </div>
                ...
                <div className="space-y-3 border-t border-gray-200 pt-4 dark:border-gray-700">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="entries">{t("filters.entriesOnly") || "Només entrades"}</option>
                      <option value="exits">{t("filters.exitsOnly") || "Només sortides"}</option>
                    </select>
                  </div>
                </div>

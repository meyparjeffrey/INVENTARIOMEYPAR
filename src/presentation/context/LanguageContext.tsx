...
const translations: Record<LanguageCode, Record<string, string>> = {
  "es-ES": {
    ...
    // Colores del tema
    "theme.colors.title": "Colores del Tema",
    "theme.colors.description": "Personaliza los colores de la aplicación en modo claro. El modo oscuro mantiene colores fijos para todos.",
    "theme.colors.primary": "Color primario",
    "theme.colors.primaryHelp": "Color principal usado en botones, enlaces y elementos destacados",
    "theme.colors.secondary": "Color secundario",
    "theme.colors.secondaryHelp": "Color usado en fondos y elementos secundarios",
    "theme.colors.preview": "Vista previa",
    "theme.colors.red": "Rojo",
    "theme.colors.blue": "Azul",
    "theme.colors.green": "Verde",
    "theme.colors.purple": "Morado",
    "theme.colors.orange": "Naranja",
    "theme.colors.pink": "Rosa",
    "theme.colors.cyan": "Cian",
    "theme.colors.indigo": "Índigo",
  ...
  "ca-ES": {
    ...
    "settings.appearance.language": "Idioma",
    // Colors del tema
    "theme.colors.title": "Colors del Tema",
    "theme.colors.description": "Personalitza els colors de l'aplicació en mode clar. El mode fosc manté colors fixos per a tothom.",
    "theme.colors.primary": "Color primari",
    "theme.colors.primaryHelp": "Color principal utilitzat en botons, enllaços i elements destacats",
    "theme.colors.secondary": "Color secundari",
    "theme.colors.secondaryHelp": "Color utilitzat en fons i elements secundaris",
    "theme.colors.preview": "Vista prèvia",
    "theme.colors.red": "Vermell",
    "theme.colors.blue": "Blau",
    "theme.colors.green": "Verd",
    "theme.colors.purple": "Morat",
    "theme.colors.orange": "Taronja",
    "theme.colors.pink": "Rosa",
    "theme.colors.cyan": "Cian",
    "theme.colors.indigo": "Índigo",

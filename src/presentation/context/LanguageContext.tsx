...
const translations: Record<LanguageCode, Record<string, string>> = {
  "es-ES": {
    ...
    "profile.initialsHelp": "Máximo 2 caracteres. Se actualiza en tiempo real en Supabase",
    "profile.changePhoto": "Cambiar foto",
    "profile.removePhoto": "Eliminar",
    "profile.uploading": "Subiendo...",
    "profile.photoHelp": "Arrastra una imagen o haz clic para seleccionar. Máximo 500KB. Formatos: JPG, PNG",
    ...
    "profile.error.validation": "Por favor, corrige los errores en el formulario antes de guardar.",
    ...
    "avatar.accessibility.highContrastHelp": "Mejora la visibilidad para usuarios con problemas de visión",
    ...
    "avatar.accessibility.altTextHelp": "Descripción del avatar para lectores de pantalla",
    // Validación perfil
    ...
    "validation.firstName.invalid": "Solo se permiten letras, espacios, guiones y apostrofes",
    ...
    "import.description": "Sube un archivo Excel para importar productos. Puedes elegir si actualizar productos existentes o solo añadir nuevos.",
    ...
    "import.options.onlyNewDesc": "Mantiene el stock de productos existentes. Solo crea productos que no existen.",
    "import.options.overwrite": "Sobrescribir todos",
    "import.options.overwriteDesc": "Actualiza productos existentes, crea los nuevos y ELIMINA los que no están en el Excel. ⚠️ La base de datos quedará exactamente como el Excel.",
    ...
    "help.products.search": "Usa la barra de búsqueda para encontrar productos por código, nombre o código de barras",
    "help.products.filters": "Usa los filtros para refinar tu búsqueda por categoría, stock, precio, etc.",
    "help.products.columns": "Configura las columnas visibles haciendo clic en el botón de columnas",
    "help.products.view": "Cambia entre vista de tabla y vista de tarjetas usando el botón de vista",
    "help.products.actions": "Haz clic en los botones de acción para ver, editar, duplicar o eliminar productos",
    ...
    "admin.import.description": "Importa productos desde un archivo Excel. Los productos existentes se actualizarán y los nuevos se crearán automáticamente.",
    ...
    "admin.import.instructions.columns": "Debe contener las columnas: CODIGO, NOMBRE, COD. PRODUCTO PROVEEDOR (opcional)",
    "admin.import.instructions.size": "Tamaño máximo: 10MB",
    "admin.import.instructions.update": "Los productos existentes se actualizarán, los nuevos se crearán",
    ...
    "batches.form.batchCodeFormat": "El código debe seguir el formato L-XXXXX (ej: L-00001)",
    ...
    "batches.form.quantityAvailableInvalid": "La cantidad disponible no puede ser mayor a la total",
    ...
    "batches.defectiveWarningDesc": "Este lote contiene productos defectuosos. Revisa todos los productos del mismo lote:",
    // Settings
    ...
    "settings.preferences.itemsPerPageHelp": "Número de elementos a mostrar en las tablas",
    "settings.notifications.title": "Notificaciones",
    "settings.notifications.enabled": "Activar notificaciones",
    "settings.notifications.enabledHelp": "Recibe notificaciones sobre alertas y eventos importantes",
    ...
    "settings.scanner.vibrationHelp": "Vibra el dispositivo cuando se escanea un código (solo móvil)",
  ...
  "ca-ES": {
    ...
    "profile.photoHelp": "Arrossega una imatge o fes clic per seleccionar. Màxim 500KB. Formats: JPG, PNG",
    ...
    "profile.error.remove": "Error al eliminar avatar",
    "profile.error.validation": "Si us plau, corregeix els errors al formulari abans de desar.",
    ...
    "avatar.preview.description": "Així es veurà el teu avatar amb la configuració actual",
    ...
    "avatar.accessibility.highContrastHelp": "Millora la visibilitat per a usuaris amb problemes de visió",
    ...
    "avatar.accessibility.altTextHelp": "Descripció de l'avatar per a lectors de pantalla",
    // Validació perfil
    ...
    "validation.firstName.invalid": "Només es permeten lletres, espais, guions i apostrofes",
    ...
    "import.description": "Puja un fitxer Excel per importar productes. Pots triar si actualitzar productes existents o només afegir nous.",
    ...
    "import.options.onlyNewDesc": "Manté l'estoc de productes existents. Només crea productes que no existeixen.",
    "import.options.overwrite": "Sobreescriure tots",
    "import.options.overwriteDesc": "Actualitza productes existents, crea els nous i ELIMINA els que no estan a l'Excel. ⚠️ La base de dades quedarà exactament com l'Excel.",
    ...
    "help.products.search": "Utilitza la barra de cerca per trobar productes per codi, nom o codi de barres",
    "help.products.filters": "Utilitza els filtres per refinar la teva cerca per categoria, estoc, preu, etc.",
    "help.products.columns": "Configura les columnes visibles fent clic al botó de columnes",
    "help.products.view": "Canvia entre vista de taula i vista de targetes usant el botó de vista",
    "help.products.actions": "Fes clic als botons d'acció per veure, editar, duplicar o eliminar productes",
    ...
    "admin.import.description": "Importa productes des d'un fitxer Excel. Els productes existents s'actualitzaran i els nous es crearan automàticament.",
    ...
    "admin.import.instructions.columns": "Ha de contenir les columnes: CODIGO, NOMBRE, COD. PRODUCTO PROVEEDOR (opcional)",
    "admin.import.instructions.size": "Mida màxima: 10MB",
    "admin.import.instructions.update": "Els productes existents s'actualitzaran, els nous es crearan",
    ...
    "batches.form.batchCodeFormat": "El codi ha de seguir el format L-XXXXX (ex: L-00001)",
    ...
    "batches.form.quantityAvailableInvalid": "La quantitat disponible no pot ser major a la total",
    ...
    "batches.defectiveWarningDesc": "Aquest lot conté productes defectuosos. Revisa tots els productes del mateix lot:",
    // Comú addicional
    ...
    "settings.notifications.enabledHelp": "Rep notificacions sobre alertes i esdeveniments importants",
    ...
    "settings.scanner.vibrationHelp": "Vibra el dispositiu quan s'escaneja un codi (només mòbil)",

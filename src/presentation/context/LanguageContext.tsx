...
const translations: Record<LanguageCode, Record<string, string>> = {
  "es-ES": {
    ...
    // Exportación
    "export.title": "Exportar a Excel",
    "export.subtitle": "Selecciona las columnas que deseas exportar",
    "export.selectAll": "Seleccionar todas",
    "export.deselectAll": "Deseleccionar todas",
    "export.selected": "seleccionadas",
    "export.export": "Exportar",
    "export.errorNoColumns": "Debes seleccionar al menos una columna",
    // Común
    ...
    "settings.theme": "Tema",
    "settings.themeDesc": "Elige entre tema claro u oscuro",
    "settings.primaryColor": "Color Principal",
    "settings.primaryColorDesc": "Color principal de la aplicación",
    "settings.secondaryColor": "Color Secundario",
    "settings.secondaryColorDesc": "Color secundario de la aplicación",
    "settings.interface": "Interfaz",
    "settings.itemsPerPage": "Elementos por página",
    "settings.dateFormat": "Formato de fecha",
    "settings.sidebarCollapsed": "Sidebar colapsado",
    "settings.sidebarCollapsedDesc": "Mostrar sidebar colapsado por defecto",
    "settings.notifications": "Notificaciones",
    "settings.notificationsEnabled": "Activar notificaciones",
    "settings.notificationsEnabledDesc": "Recibir notificaciones del sistema",
    "settings.scanner": "Escáner",
    "settings.scannerSound": "Sonido al escanear",
    "settings.scannerSoundDesc": "Reproducir sonido al escanear códigos",
    "settings.scannerVibration": "Vibración al escanear",
    "settings.scannerVibrationDesc": "Vibrar al escanear códigos",
    "settings.movements": "Movimientos",
    "settings.defaultMovementType": "Tipo de movimiento por defecto",
    "settings.movementIn": "Entrada",
    "settings.movementOut": "Salida",
    "settings.movementAdjustment": "Ajuste",
  ...
  "ca-ES": {
    ...
    // Exportació
    "export.title": "Exportar a Excel",
    "export.subtitle": "Selecciona les columnes que vols exportar",
    ...
    "profile.basicInfo": "Informació Bàsica",
    "profile.avatar": "Foto de perfil",
    "profile.firstName": "Nom",
    "profile.lastName": "Cognoms",
    "profile.email": "Correu electrònic",
    "profile.emailNotAvailable": "Correu no disponible",
    "profile.role": "Rol",
    "profile.accountInfo": "Informació de Compte",
    "profile.memberSince": "Membre des de",
    "profile.lastLogin": "Últim accés",
    "profile.quickStats": "Estadístiques",
    "profile.permissions": "Permisos",
    "profile.save": "Desar canvis",
    "profile.saving": "Desant...",
    "profile.saveSuccess": "Perfil actualitzat correctament",
    "profile.saveError": "Error en desar el perfil",
    // Configuració
    "settings.subtitle": "Personalitza la teva experiència",
    "settings.appearance": "Aparença",
    "settings.language": "Idioma",
    "settings.languageDesc": "Selecciona l'idioma de la interfície",
    "settings.theme": "Tema",
    "settings.themeDesc": "Tria entre tema clar o fosc",
    "settings.primaryColor": "Color Principal",
    "settings.primaryColorDesc": "Color principal de l'aplicació",
    "settings.secondaryColor": "Color Secundari",
    "settings.secondaryColorDesc": "Color secundari de l'aplicació",
    "settings.interface": "Interfície",
    "settings.itemsPerPage": "Elements per pàgina",
    "settings.dateFormat": "Format de data",
    "settings.sidebarCollapsed": "Sidebar col·lapsat",
    "settings.sidebarCollapsedDesc": "Mostrar sidebar col·lapsat per defecte",
    "settings.notifications": "Notificacions",
    "settings.notificationsEnabled": "Activar notificacions",
    "settings.notificationsEnabledDesc": "Rebre notificacions del sistema",
    "settings.scanner": "Escàner",
    "settings.scannerSound": "So en escanejar",
    "settings.scannerSoundDesc": "Reproduir so en escanejar codis",
    "settings.scannerVibration": "Vibració en escanejar",
    "settings.scannerVibrationDesc": "Vibrar en escanejar codis",
    "settings.movements": "Moviments",
    "settings.defaultMovementType": "Tipus de moviment per defecte",
    "settings.movementIn": "Entrada",
    "settings.movementOut": "Sortida",
    "settings.movementAdjustment": "Ajust",
    "settings.preview": "Vista prèvia",
    "settings.save": "Desar canvis",
    "settings.saving": "Desant...",
    "settings.saveSuccess": "Configuració desada correctament",
    "settings.saveError": "Error en desar la configuració",
    // Navegació
    "nav.dashboard": "Dashboard",
